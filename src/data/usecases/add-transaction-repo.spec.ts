...
import { AddTransactionRepo } from './add-transaction-repo';

const makeFakeRequest = (): AddTransactionModel => ({
  amount: 21000,
...
const makeAddTransactionRepository = (): AddTransactionProtocol => {
  class AddTransactionRepositoryStub implements AddTransactionProtocol {
...
const makeSut = () => {
  ...
  const sut = new AddTransactionRepo(addTransactionRepositoryStub);
